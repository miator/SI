...
TRAIN_CLEAN100_FEAT_ROOT = _env_path(
    "SI_TRAIN_CLEAN100_FEAT_ROOT",
    str(TRAIN_CLEAN100_PRECOMPUTED_ROOT / "train_clean100"),
)
TRAIN_CLEAN360_FEAT_ROOT = _env_path(
    "SI_TRAIN_CLEAN360_FEAT_ROOT",
    str(TRAIN_360_500_PRECOMPUTED_ROOT / "train-clean-360"),
)
TRAIN_OTHER500_FEAT_ROOT = _env_path(
    "SI_TRAIN_OTHER500_FEAT_ROOT",
    str(TRAIN_360_500_PRECOMPUTED_ROOT / "train-other-500"),
)
TRAIN_CLEAN_FEAT_ROOT = TRAIN_CLEAN100_FEAT_ROOT
TRAIN_NOISE_FEAT_ROOTS_BY_SET = {
    "clean100": _env_path("SI_TRAIN_CLEAN100_NOISE_FEAT_ROOT", str(TRAIN_CLEAN100_PRECOMPUTED_ROOT / "train_noise_snr20")),
    "clean360": _env_path("SI_TRAIN_CLEAN360_NOISE_FEAT_ROOT", str(TRAIN_360_500_PRECOMPUTED_ROOT / "train_noise_snr20")),
    "other500": _env_path("SI_TRAIN_OTHER500_NOISE_FEAT_ROOT", str(TRAIN_360_500_PRECOMPUTED_ROOT / "train_noise_snr20")),
}
TRAIN_WHITE_FEAT_ROOTS_BY_SET = {
    "clean100": _env_path("SI_TRAIN_CLEAN100_WHITE_FEAT_ROOT", str(TRAIN_CLEAN100_PRECOMPUTED_ROOT / "train_white_snr20-25")),
    "clean360": _env_path("SI_TRAIN_CLEAN360_WHITE_FEAT_ROOT", str(TRAIN_360_500_PRECOMPUTED_ROOT / "train_white_snr20-25")),
    "other500": _env_path("SI_TRAIN_OTHER500_WHITE_FEAT_ROOT", str(TRAIN_360_500_PRECOMPUTED_ROOT / "train_white_snr20-25")),
}
...
TEST_CLEAN_FEAT_ROOT = _env_path("SI_TEST_CLEAN_FEAT_ROOT", str(EVAL_PRECOMPUTED_ROOT / "test-clean"))
TEST_OTHER_FEAT_ROOT = _env_path("SI_TEST_OTHER_FEAT_ROOT", str(EVAL_PRECOMPUTED_ROOT / "test-other"))
